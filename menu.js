...
module.exports = (function () {
   ...
   */
  Menu.prototype.get_menu = function (time, name) {
    var browser = this.zombie;
                ...
                .then(function() {
                  ...
                  for (var i = 0; i < children.length; i++) {
                    ...
                    if (elm.innerHTML) {
                      ...
                      if (elm.tagName.toLowerCase() == 'h4'
                        && elm.className == 'menuCatHeader') {
                      ...
                      } else if (elm.tagName.toLowerCase() == 'p'
